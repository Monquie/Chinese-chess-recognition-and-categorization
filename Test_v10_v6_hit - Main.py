...
img_set = [[img1a,"xe_do"],[img1b,"ma_do"],[img1c,"si_do"],[img1d,"vua_do"],[img1e,"tinh_do"],[img1f,"tot_do"],[img1g,"phao_do"],[img1h,"tot_den"],[img1i,"ma_den"],[img1j,"vua_den"],[img1k,"xe_den"],[img1l,"si_den"],[img1m,"phao_den"],[img1n,"tinh_den"]]
...
def FindCircles():
	...
	while(vs.success):
		...
		CircleSet_org = cv2.HoughCircles(image=img,method=cv2.HOUGH_GRADIENT,dp=1,minDist=30, 
									param1=220,param2=40,minRadius=27,maxRadius=33)

		if CircleSet_org is None:
			cv2.imshow('ImageResult',InputImage)
		else:
			...
			if CircleSet is None:
				...
				if not QueueSet.empty():
					# ShowImage	=	cv2.putText(InputImage,chess_name, (x,y), font, 
